...
@section('content')
                        ...
                        <table class="table table-bordered role-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ ___('student_info.payment_view') }}</th>
                                ...
                                <tr id="row_{{ @$row->student->id }}">
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-sm ot-btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#studentPaymentInfo" onclick="studentPaymntInformation({{ $row->id }})">
    ...
    <div id="view-modal-grave-info">
        <div class="modal " id="studentPaymentInfo" tabindex="-1" aria-labelledby="modalWidth" aria-hidden="true">
...
<script>
    function studentPaymntInformation(id) {
    var url = $('#url').val();
    var formData = {
        student_id: id,
    }
    ...
    $.ajax({
        ...
        url: url + '/student/get-fees-collect',
        success: function (data) {
          
            $("#studentPaymentInfo .modal-dialog").html(data);
        },
        error: function (data) {
            console.log(data);
        }
