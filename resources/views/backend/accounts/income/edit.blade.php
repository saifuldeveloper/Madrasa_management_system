                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="validationServer04" class="form-label">{{ ___('common.donar_name') }} <span
                                        class="fillable">*</span></label>

                                    <select class="nice-select niceSelect bordered_style wide @error('donar_id') is-invalid @enderror"
                                    name="donar_id" id="">
                                    @foreach ($data['donar'] as $item)
                                        <option value="{{ $item->id }}"{{ old('donar_id',@$data['income']->donar_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ ___('account.receipt_number') }} </label>
