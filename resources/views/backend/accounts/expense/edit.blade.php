                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ ___('account.quantity') }} </label>
                                    <input class="form-control ot-input @error('quantity') is-invalid @enderror" name="quantity"
                                        value="{{ @$data['expense']->quantity }}"  list="datalistOptions" id="exampleDataList" type="number" 
                                        placeholder="{{ ___('account.enter_quantity') }}">
                                    @error('quantity')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <label for="validationServer04" class="form-label">{{ ___('account.unit') }} <span
                                        class="fillable"></span></label>
                                    <select class="nice-select niceSelect bordered_style wide @error('unit') is-invalid @enderror"
                                    name="unit" id="validationServer04"
                                    aria-describedby="validationServer04Feedback">
                                        <option value="1" {{ old('unit',@$data['expense']->unit) == 1 ? 'selected' : '' }} >{{ ___('account.kg') }}</option>
                                        <option value="2"  {{ old('unit',@$data['expense']->unit) == 2 ? 'selected' : '' }} >{{ ___('account.liter') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
