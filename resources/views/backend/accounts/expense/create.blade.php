                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('quantity') is-invalid @enderror" name="quantity"
                                        value="{{ old('quantity') }}" list="datalistOptions" id="exampleDataList" type="number"
                                ...
                                <div class="col-md-6">
                                    ...
                                    aria-describedby="validationServer04Feedback">
                                        ...
                                        <option value="1" {{ old('unit') == $item->id ? 'selected' : '' }}>{{ ___('account.kg') }}</option>
                                        <option value="2" {{ old('unit') == $item->id ? 'selected' : '' }}>{{ ___('account.liter') }}</option>
