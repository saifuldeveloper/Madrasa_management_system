...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('graveslist.update', @$data['grave']->id) }}" enctype="multipart/form-data" method="post"
                    id="visitForm">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input name="address" placeholder="{{ ___('common.address') }}" value="{{ $data['grave']->address }}"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('email') is-invalid @enderror"
                                        ...
                                        placeholder="{{ ___('student_info.enter_email') }}" value="{{ $data['grave']->relative_email }}">
                                    @error('email')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name_of_the_relationship') is-invalid @enderror"
                                        ...
                                        placeholder="{{ ___('common.name_of_the_relationship') }}" value="{{ $data['grave']->name_of_the_relationship }}">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input name="relative_present_address" placeholder="{{ ___('common.present_address') }}"
                                        class=" form-control ot-input mb_30" value="{{ $data['grave']->relative_present_address }}" type="text">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">{{ ___('common.parmanent_address') }} </label>
                                    <input name="relative_parmanent_address" value="{{ $data['grave']->relative_parmanent_address }}" placeholder="{{ ___('common.parmanent_address') }}"
