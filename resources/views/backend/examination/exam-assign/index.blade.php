            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('exam_assign_create'))
                        <a href="{{ route('exam-assign.create') }}" class="btn btn-lg ot-btn-primary">
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end ">
                                                    ...
                                                    @endif
                                                    @if (hasPermission('exam_assign_delete'))
                                                        <li>
                                                            <input type="hidden" name="" value="{{___('examination.already_mark_registered_they_will_also_be_deleted')}}" class="note">
