    ...
    <div class="sidebar-menu srollbar">
        <div class="sidebar-menu-section">
            ...
            <ul class="sidebar-dropdown-menu">
                ...
                <li class="sidebar-menu-item {{ set_menu(['online-admissions*']) }}">
                    ...
                    <ul class="child-menu-list">
                        ...
                        <li class="sidebar-menu-item {{ set_menu(['online-admissions.setting.fees']) }}">
                            <a href="{{ route('online-admissions.setting.fees') }}">{{ ___('common.admission_fees') }}</a>
                        </li>
                        @endif
                        @if (hasPermission('certificate_generate_read'))
                ...
                <li class="sidebar-menu-item {{ set_menu(['graves*','grave*', 'grave/list*']) }}">
                    <a class="parent-item-content has-arrow">
                        <i class="las la-users"></i>
                        <span class="on-half-expanded">{{ ___('common.grave_info') }}</span>
                    </a>
                    ...
                    <ul class="child-menu-list">
                        {{-- <li class="sidebar-menu-item">
                            <a href="{{ route('graves.index') }}">{{ ___('common.grave_row') }}</a>
                        </li> --}}
                        <li class="sidebar-menu-item">
                            <a href="{{ route('graveslist.index') }}">{{ ___('common.grave_list') }}</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-menu-item {{ set_menu([
                    ...
                    <a class="parent-item-content has-arrow">
                        ...
                        <span class="on-half-expanded">{{ ___('account.account') }}</span>
                    </a>
                    <ul class="child-menu-list">
                        <li class="sidebar-menu-item {{ set_menu(['income*']) }}">
                            <a href="{{ route('donar.index') }}">{{ ___('common.donar') }}</a>
                        </li>
                        @if (hasPermission('account_head_read'))
                        <li class="sidebar-menu-item {{ set_menu([
                            'account_head.index',
                ...
                <li class="sidebar-menu-item {{ set_menu(['report-*']) }}">
                    ...
                    <ul class="child-menu-list">
                        ...
                        <li class="sidebar-menu-item {{ set_menu(['report-graves*']) }}">
                            <a href="{{ route('graveslist.filter') }}">{{ ___('common.grave') }}</a>
                        </li>
                    </ul>
                </li>
                @endif
