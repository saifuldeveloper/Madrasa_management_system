...
use App\Repositories\Donar\DonarRepository;
use App\Repositories\Graves\GraveRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(GraveRowInterface::class,  GraveRowRepository::class);    
        $this->app->bind(GraveInterface::class,  GraveRepository::class);    
        $this->app->bind(DonarInterface::class,  DonarRepository::class);    
