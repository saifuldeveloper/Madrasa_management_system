...
class FeesMasterRepository implements FeesMasterInterface
{
    ...
    {
        return $this->model::with('classSetup.class')->latest()->where('session_id',setting('session'))->paginate(10);
    }
    ...
    public function store($request)
    {
        ...
        try {
            ...
            if ($this->model->where('session_id',
               setting('session'))->where('fees_group_id',$request->fees_group_id)
            ...
            $row->class_setup_id = $request->class_setup_id;
